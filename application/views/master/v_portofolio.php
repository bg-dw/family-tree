                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img alt="image" src="<?= base_url() ?>assets/img/users/user-1.png" width="35">
                                        <img alt="image" src="<?= base_url() ?>assets/img/users/user-3.png" width="35">
                                        <img alt="image" src="<?= base_url() ?>assets/img/users/user-4.png" width="35">
                                    </td>
                                    <td>2018-04-10</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img alt="image" src="<?= base_url() ?>assets/img/users/user-1.png" width="35">
                                        <img alt="image" src="<?= base_url() ?>assets/img/users/user-2.png" width="35">
                                    </td>
                                    <td>2018-01-29</td>
                                    <td>
