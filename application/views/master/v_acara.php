    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body" id="tbl_add" style="display: none;">
          <form action="<?= base_url('master-acara-add') ?>" method="post" onsubmit="return confirm('Simpan Data?');">
        ...
        <div class="card-body" id="tbl_update" style="display: none;">
          <form action="<?= base_url('master-acara-update') ?>" method="post"
...
<div class="modal fade" id="upload-foto-acara" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('master-acara-update-foto') ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form action="<?= base_url('master-acara-delete') ?>" method="post">
        <div class="modal-body">
