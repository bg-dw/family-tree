  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
                    ...
                    <td>
                      <?php if ($baris->u_pic): ?>
                        <img src="<?= base_url() ?>assets/img/users/profile/<?= $baris->u_pic ?>" class="user-img" alt=""
                          ...
                          data-toggle="tooltip" title="Klik Untuk Ubah Foto">
                      <?php else: ?>
        ...
        <form action="<?= base_url('usm-add-pengguna') ?>" method="post" onsubmit="return confirm('Simpan data?');"
...
<div class="modal fade" id="upload-foto-pengguna" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('usm-update-foto-pengguna') ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
