...
<head>
  ...
  <?php $this->load->view('_layout/l_header'); ?>
</head>
...
<body>
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="<?= base_url('profile-usm') ?>" class="dropdown-item has-icon"> <i class="far
                    fa-user"></i> Profile
              </a>
      ...
      <?php $this->load->view('_layout/usm/l_menu'); ?>
      <!-- Main Content -->
      <div class="main-content">
        ...
        <div class="modal fade" id="update-username" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <form method="post" action="<?= base_url('usm-update-username') ?>"
        ...
        <div class="modal fade" id="update-password" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <form method="post" class="needs-validation" action="<?= base_url('usm-update-password') ?>"
                onsubmit="return confirm('Simpan, dan Masuk Ulang?')">
                <div class=" modal-header">
  ...
  <?php $this->load->view('_layout/l_footer'); ?>
